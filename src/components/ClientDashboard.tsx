            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">Название и описание для менеджера</p>
                </div>
              </div>
              ...
              {created ? (
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">Описание для менеджера</label>
                    <textarea
                      value={description}
                      onChange={e => setDescription(e.target.value)}
                      placeholder="Кратко опишите задачу, сроки, особенности..."
                      rows={3}
